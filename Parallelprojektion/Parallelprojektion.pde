...
PVector Quelle = new PVector(175, -150, 100*300);
PVector originaleQuelle = new PVector(175, -150, 100*300);
float z = 0;
...
PVector kreisfoermigeQuelle(PVector tmpQuelle) {
  tmpQuelle.x = 30000 * sin(2*PI * (frameCounter % 1000)/1000.0) + 100;
  tmpQuelle.y = 30000 * cos(2*PI * (frameCounter % 1000)/1000.0) + 100;
